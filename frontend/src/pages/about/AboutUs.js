    ...
    {/* <h2 className="text-center text-uppercase">About Us</h2> */}
      <div className="content-section row mt-5">
        <div className="content-card col-md-6 mb-4" id="our-story">
          <h2 className=" text-center "><i className="fas fa-mountain text-center "></i> Our Story</h2>
        ...
        <div className="content-card col-md-6 mb-4" id="team">
          <h2 className=" text-center "><i className="fas fa-users text-center "></i> Meet Our Team</h2>
