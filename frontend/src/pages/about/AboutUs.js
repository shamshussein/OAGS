    ...
    <section id="about-us" className="container py-5">
      ...
      <div className="content-section row mt-5">
        <div className="content-card col-md-6 mb-4" id="our-story">
          <h2 className="text-success"><i className="fas fa-mountain"></i> Our Story</h2>
          ...
          <ul className="list-unstyled">
            <li><i className="fas fa-check-circle text-success"></i> Founded in 2024 with passion and purpose</li>
            <li><i className="fas fa-users text-success"></i> Over 100,000 adventurers served</li>
            <li><i className="fas fa-star text-success"></i> Rated #1 in customer satisfaction</li>
          </ul>
        </div>

        <div className="content-card col-md-6 mb-4" id="team">
          <h2 className="text-success"><i className="fas fa-users"></i> Meet Our Team</h2>
      ...
      <div className="location-section text-center mt-5">
        <h2 className="text-success">Our Location</h2>
